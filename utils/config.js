const POSITIVE_INT_ENV_SPECS = new Map([
  ...
  ['RATE_LIMIT_MAX_KEYS', { fallback: 10_000 }],
  ['RATE_LIMIT_CLEANUP_INTERVAL_MS', { fallback: 60_000, allowZero: true }],
  ['GALLERY_STAT_CONCURRENCY', { fallback: 16 }],
  ['GALLERY_MAINTENANCE_SCAN_PAGE_SIZE', { fallback: 500 }],
  ['GALLERY_ORPHAN_SCAN_MAX_DB_ROWS', { fallback: 50_000 }],
  ['GALLERY_ORPHAN_SCAN_MAX_FILES', { fallback: 20_000 }],
  ['GALLERY_ORPHAN_SCAN_MAX_DIRS', { fallback: 5_000 }],
  ['GALLERY_ORPHAN_SCAN_TIMEOUT_MS', { fallback: 15_000 }],
