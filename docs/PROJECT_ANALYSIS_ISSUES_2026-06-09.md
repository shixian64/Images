...
> 维护说明（2026-06-11）：本文是 2026-06-09 的原始审计快照，部分条目已被后续提交修复或降低风险；当前状态见 [`PROJECT_ISSUE_REMEDIATION_STATUS_2026-06-11.md`](PROJECT_ISSUE_REMEDIATION_STATUS_2026-06-11.md)。
