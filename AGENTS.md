...
This project is indexed by GitNexus as **Images** (3505 symbols, 7540 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
