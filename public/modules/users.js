...
const MANAGEMENT_TABS = new Set(['usersManagement', 'quotaManagement', 'interfaceManagement', 'galleryManagement']);
...
async function refreshGlobalInterface({ silent = false } = {}) {
  try {
...
function bindGlobalInterfacePanel() {
